...
/* ── Initials fallback ── */
const ACCENTS = [
  '#4F9CF9','#34D399','#A78BFA','#FBBF24','#F87171',
    ...
    <div className="flex-shrink-0 flex flex-col items-center gap-2.5 px-5 group cursor-default">
      ...
      >
        {!failed ? (
          ...
          <span className="text-xs font-bold" style={{ color: ac }}>{ini}</span>
        )}
      </div>
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div
        ...
        style={{ animation: `${anim} ${speed} linear infinite`, willChange: 'transform' }}
      >
        {items.map((c, i) => (
    ...
    <section className="bg-black border-t border-white/[0.06] py-16 overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto px-6 text-center mb-12">
        ...
        <p className="text-white/60 text-sm">
          ...
          {' '}companies already working with Selected Group
        </p>
      </div>
