  ...
  return (
    <div className="bg-black min-h-screen">
      ...
      <div className="pt-32 pb-16 px-6 relative overflow-hidden bg-black">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex items-center gap-3 mb-5">
            <span className="w-8 h-px" style={{ backgroundColor: '#A78BFA' }} />
            <span className="text-xs font-semibold tracking-[0.3em] uppercase" style={{ color: '#A78BFA' }}>
              Specialist Practice
            </span>
          </div>
          ...
          <h1 className="text-[3.25rem] font-bold text-white tracking-tight mb-4 max-w-3xl leading-tight">
            ...
            <span
              ...
              style={{ backgroundImage: 'linear-gradient(120deg, #ffffff 30%, #A78BFA)' }}
            >
              Management
            </span>
          </h1>
          ...
          <p className="text-white/50 text-base md:text-lg max-w-2xl leading-relaxed mb-8">
            Product management sits at the centre of every successful technology business — connecting customer needs,
            commercial strategy and engineering execution. We operate across the full product lifecycle, from
            early-stage discovery through to scaling mature product organisations.
          </p>
      ...
      <div
        ...
        style={{ background: 'linear-gradient(135deg, #120b2e 0%, #0d1a3a 50%, #120b2e 100%)' }}
      >
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            {stats.map((s) => (
              <div key={s.label}>
                <div className="text-3xl md:text-4xl font-bold mb-2 tracking-tight" style={{ color: '#A78BFA' }}>
                  {s.value}
                </div>
      ...
      <div className="border-t border-white/[0.05] py-20 px-6 text-center relative overflow-hidden">
        <div
          className="absolute -top-40 left-1/2 -translate-x-1/2 w-[500px] h-[500px] rounded-full blur-[140px] pointer-events-none opacity-25"
