    ...
    items: [
      {
        ...
        bullets: ["Closes deals & runs demos", "Owns revenue targets", "Split: SMB · Mid-Market · Enterprise"],
      },
      {
        name: "SDR / BDR",
        bullets: ["Outbound prospecting & outreach", "Qualifies inbound leads", "Books meetings for AEs"],
      },
      {
        name: "Enterprise Sales",
        bullets: ["Large, complex multi-stakeholder deals", "Long relationship-driven cycles", "Executive-level engagement"],
      },
      {
        name: "Solutions Consultant",
        bullets: ["Technical pre-sales support", "Explains APIs & integrations", "Bridges product and sales"],
      },
      {
        name: "Account Manager",
        bullets: ["Manages existing customers", "Upsell & cross-sell expansion", "Retention-focused growth"],
      },
      {
        name: "Channel / Partner Sales",
        bullets: ["Sells through resellers", "Manages indirect revenue", "Partner enablement"],
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        bullets: ["Messaging & positioning", "Launch strategy & enablement", "Competitive intel & ICP development"],
      },
      {
        name: "Demand Generation",
        bullets: ["Pipeline creation", "Paid campaigns & automation", "Lead generation at scale"],
      },
      {
        name: "Growth Marketing",
        bullets: ["Conversion optimisation", "Acquisition funnels & PLG", "Rapid experimentation"],
      },
      {
        name: "Content Marketing",
        bullets: ["Blogs, whitepapers & SEO", "Case studies & thought leadership", "Long-form brand authority"],
      },
      {
        name: "Brand Marketing",
        bullets: ["Company reputation & awareness", "Creative direction", "Narrative and tone of voice"],
      },
      {
        name: "Field Marketing",
        bullets: ["Events & webinars", "Regional campaigns", "In-person pipeline acceleration"],
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        bullets: ["Owns post-sale relationship", "Drives adoption & prevents churn", "Helps customers hit outcomes"],
      },
      {
        name: "Technical Account Manager",
        bullets: ["Strategic technical advisor", "Enterprise customer focus", "Complex integration support"],
      },
      {
        name: "Implementation Specialist",
        bullets: ["Product deployment & setup", "Training & onboarding", "Time-to-value acceleration"],
      },
      {
        name: "Renewals Manager",
        bullets: ["Contract renewal ownership", "Churn risk identification", "Expansion pipeline"],
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        bullets: ["Forecasting & CRM management", "Pipeline analytics & GTM tooling", "Compensation plans & process optimisation"],
      },
      {
        name: "Sales Operations",
        bullets: ["Territory planning & reporting", "Sales process management", "Quota & attainment tracking"],
      },
      {
        name: "Marketing Operations",
        bullets: ["HubSpot / Marketo management", "Attribution modelling", "Campaign systems & data hygiene"],
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        bullets: ["Strategic alliances & co-selling", "Integration partner development", "Partner-sourced pipeline"],
      },
      {
        name: "Alliance Manager",
        bullets: ["Microsoft, AWS, Salesforce relationships", "Executive sponsor alignment", "Joint go-to-market planning"],
      },
      {
        name: "Technology Partnerships",
        bullets: ["Product integration ecosystem", "API & marketplace presence", "Partner technical enablement"],
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        bullets: ["Deep technical customer design", "Enterprise implementation scoping", "Pre & post-sale architecture"],
      },
      {
        name: "Developer Relations",
        bullets: ["Developer community engagement", "Technical content & demos", "Open-source advocacy"],
      },
      {
        name: "Forward Deployed Engineer",
        bullets: ["Customer-facing engineering", "On-site implementation support", "Feedback loop to product"],
      },
      {
        name: "AI / Technical Evangelist",
        bullets: ["Market education on AI capabilities", "Conference & content presence", "Translates technical to commercial"],
      },
    ],
  },
];
...
const careerPaths = [
  ...
  },
  {
    label: "Marketing",
    accent: "#7EB8C9",
    steps: ["Content / Growth", "Product Marketing", "Senior PMM", "Director PMM"],
  },
  {
  ...
  },
  {
    label: "Technical GTM",
    accent: "#8FA3FF",
    steps: ["Sales Engineer", "Solutions Architect", "Field CTO", "VP Solutions"],
  },
];

// ── Personality fit table ────────────────────────────────────────────────────
const personalityFit = [
  { type: "Competitive / persuasive", roles: "Sales · Enterprise AE", accent: "#C8A96B" },
  { type: "Analytical", roles: "RevOps · Growth Marketing", accent: "#C47EB5" },
  { type: "Creative", roles: "Brand · Content Marketing", accent: "#7EB8C9" },
  { type: "Strategic communicator", roles: "Product Marketing Manager", accent: "#A3C98A" },
  { type: "Relationship-driven", roles: "Customer Success · Partnerships", accent: "#E07A5F" },
  { type: "Technical + social", roles: "Solutions Engineer · DevRel", accent: "#8FA3FF" },
  { type: "Process-oriented", roles: "Revenue Operations", accent: "#C47EB5" },
  { type: "Big-picture thinker", roles: "GTM Strategy · CRO", accent: "#C8A96B" },
];
    ...
    <div className="border-b border-white/[0.06]">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 pb-12">
          {/* Divider */}
          <div className="h-px mb-10" style={{ background: `${row.accent}30` }} />
            ...
            {row.items.map((item) => (
              ...
              >
                ...
                <ul className="space-y-2">
                  {item.bullets.map((b) => (
                    <li key={b} className="flex items-start gap-2 text-white/50 text-sm">
                      <span
...
// ── Main page ────────────────────────────────────────────────────────────────
export default function GTMExpertisePage() {
    ...
    <div className="bg-black min-h-screen text-white overflow-hidden">
      ...
      <section className="relative border-b border-white/[0.06]">
        ...
        <div className="relative max-w-7xl mx-auto px-6 pt-36 pb-28">
          ...
          <p className="mt-8 max-w-2xl text-white/60 text-lg leading-relaxed">
            ...
            generating revenue, scaling adoption, and driving long-term customer growth
            across modern SaaS and AI businesses.
          </p>
      ...
      <section className="py-24 border-b border-white/[0.06]">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <div className="flex items-center justify-center gap-3 mb-6">
            ...
            <span className="text-white/50 text-xs tracking-[0.3em] uppercase">GTM Structure</span>
            <span className="w-8 h-px bg-white/20" />
          </div>
          ...
          <p className="text-white/55 text-lg leading-relaxed">
            ...
            partnerships, revenue operations, and technical customer-facing teams.
            Together, these functions drive pipeline creation, customer retention,
            product adoption, and scalable revenue growth.
          </p>
        </div>
      </section>
            ...
            {sections.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-white/55 leading-relaxed mb-8">{item.description}</p>
                  <div className="space-y-3">
                    {item.roles.map((role) => (
                      <div key={role} className="flex items-center gap-3 text-white/75 text-sm">
      ...
      <section className="border-t border-white/[0.06] bg-[#050505]">
        ...
        <div className="max-w-7xl mx-auto px-6 pt-20 pb-12">
          <div className="flex items-center gap-3 mb-6">
            <span className="w-8 h-px bg-[#C8A96B]" />
            <span className="text-[#C8A96B] text-xs tracking-[0.3em] uppercase">Role Breakdown</span>
          </div>
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            ...
            <p className="text-white/45 text-sm leading-relaxed max-w-sm md:text-right">
              Explore each function in detail — what the roles do, how they fit together,
              and where they sit in a modern GTM org.
            </p>
          </div>
        </div>
      ...
      <section className="border-t border-white/[0.06] py-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center gap-3 mb-4">
            <span className="w-8 h-px bg-[#C8A96B]" />
            <span className="text-[#C8A96B] text-xs tracking-[0.3em] uppercase">Progression</span>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                <span className="w-8 h-px bg-[#C8A96B]" />
                <span className="text-[#C8A96B] text-xs tracking-[0.3em] uppercase">Role Fit</span>
              </div>
              ...
              <p className="text-white/50 text-base leading-relaxed max-w-sm">
                GTM spans personalities from competitive closers to analytical operators.
                Different functions reward different strengths — the key is knowing where
                your natural edge compounds.
              </p>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-white/55 text-lg leading-relaxed">
                Demand continues to accelerate across enterprise SaaS,
                AI-native businesses, cloud infrastructure companies,
                and platform technology organisations.
              </p>
            </div>
      ...
      <section className="border-t border-white/[0.06] py-24 text-center">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <p className="text-white/55 text-lg leading-relaxed mb-10">
            ...
            commercial, operational, and technical GTM talent across global markets.
          </p>
          <button
            onClick={() => navigate("/contact")}
            className="group inline-flex items-center gap-3 bg-white text-black px-8 py-4 text-sm font-bold tracking-widest uppercase transition-all duration-300 hover:bg-white/90"
